...
class ReadOneAttributeValueTest extends AbstractAttributeValueTest
{
    public function testReadOneAttributeValue()
    {
        $permission = $this->createPermission('ReadOneAttributeValue');
