...
class ReadPageAdminTest extends AbstractAdminTest
{
    ...
    public function testReadPageAdmin()
    {
        $permission = $this->createPermission('ReadPageAdmin');
        ...
        $response->assertJsonCount(3, 'page.data');
