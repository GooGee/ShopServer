...
class ReadPageNotificationTest extends AbstractNotificationTest
{
    ...
    public function testReadPageNotification()
    {
        $permission = $this->createPermission('ReadPageNotification');
