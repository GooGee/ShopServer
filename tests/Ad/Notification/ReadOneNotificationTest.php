...
class ReadOneNotificationTest extends AbstractNotificationTest
{
    public function testReadOneNotification()
    {
        $permission = $this->createPermission('ReadOneNotification');
